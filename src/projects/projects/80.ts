...
export const Project: AudioBookProjectType = {
  ...
  image: `${process.env.PUBLIC_URL}/media/80/МОТАНКА-3-2.svg`,
  audio: `${process.env.PUBLIC_URL}/media/80/Вінок_Аудіокнига_Новела_Катерини_Пилипчук_Читає_авторка_128_kbps.mp3`,
  tags: [],
