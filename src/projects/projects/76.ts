...
export const Project: AudioBookProjectType = {
  ...
  image: `${process.env.PUBLIC_URL}/media/76/МОТАНКА-3-5.svg`,
  audio: `${process.env.PUBLIC_URL}/media/76/Софія_Аудіокнига_Весняне_інтермецо_у_трьох_частинах_Катерини_Пилипчук.mp3`,
  tags: [],
