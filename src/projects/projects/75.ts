...
export const Project: AudioBookProjectType = {
  ...
  image: `${process.env.PUBLIC_URL}/media/75/МОТАНКА-3-7.svg`,
  audio: `${process.env.PUBLIC_URL}/media/75/Carpe_Diem_Новела_Катерини_Пилипчук_Аудіокнига_Читає_авторка_128.mp3`,
  tags: [],
