...
export const Project: AudioBookProjectType = {
  category: "sound",
  id: 55,
  name: "Українська мрія",
  author: "Катерина Пилипчук",
  subcategory: "audioBook",
  image: `${process.env.PUBLIC_URL}/media/55/МОТАНКА-3-2.svg`,
  audio: `${process.env.PUBLIC_URL}/media/55/Українська_мрія_Аудіокнига_Патріотична_новела_Катерини_Пилипчук.mp3`,
  tags: [],
