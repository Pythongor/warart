...
export const Project: AudioBookProjectType = {
  ...
  image: `${process.env.PUBLIC_URL}/media/77/МОТАНКА-3-6.svg`,
  audio: `${process.env.PUBLIC_URL}/media/77/Гривня_Новела_Катерини_Пилипчук_Аудіокнига_Читає_авторка_128_kbps.mp3`,
  tags: [],
