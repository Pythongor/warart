...
export const Project: AudioBookProjectType = {
  category: "sound",
  id: 79,
  name: "Галопом по Європах",
  author: "Катерина Пилипчук",
  subcategory: "audioBook",
  image: `${process.env.PUBLIC_URL}/media/79/МОТАНКА-3-3.svg`,
  audio: `${process.env.PUBLIC_URL}/media/79/Галопом_по_Європах_Аудіокнига_Оповідання_Катерини_Пилипчук_Читає.mp3`,
  tags: [],
